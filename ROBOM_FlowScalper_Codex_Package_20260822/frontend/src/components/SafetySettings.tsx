...
type Props = { data: DashboardData; onNewRun: () => void }

export function SafetySettings({ data, onNewRun }: Props) {
  ...
  return (
    <section aria-labelledby="risk-heading">
      <div className="page-heading"><div><p className="section-kicker">자동 안전장치</p><h2 id="risk-heading">안전 설정</h2><p className="heading-help">기간 한도 없이 연구하되 데이터·원장·계획손실·호가 검증은 지킵니다.</p></div><span className="page-note">PAPER 전용</span></div>
