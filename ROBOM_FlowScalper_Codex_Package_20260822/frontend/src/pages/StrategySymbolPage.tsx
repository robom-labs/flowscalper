...
export function StrategySymbolPage({ strategies }: Props) {
  ...
  useEffect(() => {
    ...
    void fetchJson<StrategySymbolResponse>('/api/analytics/strategy-symbols', { signal: controller.signal }).then((response) => setRows(response.rows)).catch(() => setRows([]))
