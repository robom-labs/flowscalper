...
export function PerformancePage({ data, strategies, leagueAccounts, history }: Props) {
  ...
  return (
    <section aria-labelledby="performance-heading">
      <div className="page-heading"><div><p className="section-kicker">전략별 결과</p><h2 id="performance-heading">성과</h2><p className="heading-help">여섯 전략의 독립 가상계좌를 같은 기준으로 비교합니다.</p></div><span className="calibrating">표본이 적으면 데이터 모으는 중</span></div>
