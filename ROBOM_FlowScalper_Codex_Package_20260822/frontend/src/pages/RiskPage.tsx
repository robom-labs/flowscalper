// 공동계좌와 Strategy League 계좌의 서로 다른 PAPER 위험계약을 분리해 표시한다.
import type { DashboardData } from '../types'

type Props = { data: DashboardData; onPauseToggle: () => void; onNewRun: () => void }
