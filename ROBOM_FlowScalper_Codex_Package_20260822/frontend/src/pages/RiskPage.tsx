...
export function RiskPage({ data, onPauseToggle, onNewRun }: Props) {
  ...
  return (
    <section aria-labelledby="risk-heading">
      <div className="page-heading"><div><p className="section-kicker">FAIL-CLOSED LIMITS</p><h2 id="risk-heading">위험관리</h2><p className="heading-help">조건이 불확실하면 거래를 만들지 않는 방향으로 자동 잠급니다.</p></div><span className="page-note">현재 Run 가정은 변경 불가</span></div>
