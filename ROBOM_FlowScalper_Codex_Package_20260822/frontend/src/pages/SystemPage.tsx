...
const diagnosticLabels: Record<string, string> = {
  ...
  wal_autocheckpoint_pages: 'COMMIT 내 자동 checkpoint 페이지',
  wal_checkpoint_flush_interval: '분리 checkpoint 저장주기',
  wal_checkpoint_count: '분리 WAL checkpoint 횟수',
  ...
  wal_checkpoint_last_completed_ts_ms: '최근 WAL checkpoint 완료시각 ms',
