...
export const initialDashboard: DashboardData = {
  ...
  paper_activity: {
    ...
    shared_run_completed_trades: 0,
    shared_today_completed_trades: 0,
    shared_today_realized_pnl_usdt: '0',
    strategy_current_unique_opportunities: 0,
    strategy_today_unique_opportunities: 0,
    strategy_current_raw_result_rows: 0,
    strategy_today_raw_result_rows: 0,
    strategy_grouping_status: 'PROVEN',
    paper_only: true,
    real_orders_enabled: false,
  },
  performance: {
