...
| Upgrade 28 | COMPLETE | archive manifest·이벤트 통계·캔들을 `synchronous=FULL` 한 커밋으로 원자 저장하고 구형 manifest/candle 시간 진단을 통합 원장 시간으로 교체했다. backend 318·frontend 47·Playwright 3·전체 정적·build·security·repository hygiene PASS. 실제 `run-2b0119b86432` 56,260 events·28 flush에서 최대 1.506초, 2초 이상 0, p95 마지막 75.969ms, critical/reconnect/gap/drop/fault 0이었다. 실제 브라우저 A~J 24경로·양방향과 자연 Depth-adjusted OFI BTCUSDT BASE/STRESS 진입·TP/SL·13.612초 종료를 확인했고 GitHub Actions 32815768312가 PASS했다. | 전략 수익성·6h·24h·Release ZIP NOT_RUN | 장기 PAPER 모니터 지속 |
...
| 28 | COMPLETE | ef12928 | Backend 318·frontend 47·Playwright desktop/tablet/mobile 3·Ruff·mypy 82·ESLint·TypeScript·build·PAPER safety·security 115 source·repository hygiene PASS. FULL 단일 커밋과 rollback·버퍼복구를 검증했고 실제 56,260 events·28 flush 최대 1.506초·slow 0·critical/reconnect/gap/drop/fault 0, A~J 정상감시·자연 shadow 8건·최단 13.612초, GitHub Actions 32815768312 PASS를 확인했다. | 전략 수익성·6h·24h·Release ZIP NOT_RUN | 장기 PAPER 모니터 지속 |
