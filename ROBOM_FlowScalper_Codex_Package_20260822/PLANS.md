...
| Upgrade 36 | COMPLETE_WITH_LIMITS | 거래기록 기본 전체계좌·LIVE cache·로딩/건수 표시와 replay 최근 candle 미리보기·명시적 정밀 이벤트/전략 검증을 구현했다. backend 361·frontend 53·fixture 15·Playwright 3·정적·build·PAPER safety·security·repository hygiene PASS다. 실제 기록 22건, history 반복 22.8~34.3ms, preview 199ms, 정밀 24 events 631ms, 전략 검증 1.95초와 주문·인증 0을 확인했다. | 검증 부하 중 저장 커밋 14.261초로 안전대기 86.3초 뒤 자동복구 PASS_WITH_LIMIT, 수익성 NOT_PROVEN, 6h·24h·Release ZIP NOT_RUN | 현재 revision 자연표본과 장기 PAPER 모니터 지속 |
...
| 36 | COMPLETE_WITH_LIMITS | ba97231 | Backend 362·frontend 53·fixture 15·Playwright desktop/tablet/mobile 3·Ruff·mypy 91·ESLint·TypeScript·build·PAPER safety·security 124 source·repository hygiene PASS다. 실제 8870 거래기록 공동 0·전략별 28건, checkpoint 경합 수정 뒤 거래기록 12회 9.8~30.8ms·Run 목록 2.5~19.2ms, 정밀 24 events와 동일조건 전략검증·checksum 일치·실제주문/인증 0·console 오류 0을 확인했다. GitHub Actions 32910918615의 validate 58초·browser 1분46초·증거업로드도 PASS했다. | 검증 부하 중 자동 안전대기 86.3초 뒤 복구 PASS_WITH_LIMIT, 수익성 NOT_PROVEN, 6h·24h·Release ZIP NOT_RUN | 현재 revision 자연표본과 장기 PAPER 모니터 지속 |
